...
"To detect the cores and make the clusters as single unit"
clusters <- makeCluster(detectCores())

"print the number of cores"
clusters

"Register the cores as a cluster. cores attribute will utilize the specified cores"
registerDoParallel(clusters, cores = 2)

"To use cores at any point of time, in case not registered or change the cores"
#options(cores=3)
